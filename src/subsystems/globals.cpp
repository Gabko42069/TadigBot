...
lemlib::Drivetrain drivetrain(&left_side_motors, // left motor group
                              ...
                              lemlib::Omniwheel::NEW_325, // using new 3.25"
omnis 450, // drivetrain rpm is 360
                              8
);
...
lemlib::ControllerSettings linearController(11, // proportional gain (kP)
                                            ...
                                            200, // small error range timeout,
in milliseconds 3, // large error range, in inches 500, // large error range
timeout, in milliseconds 20 // maximum acceleration (slew)
);
...
in milliseconds 3, // large error range, in degrees 500, // large error range
timeout, in milliseconds 0 // maximum acceleration (slew)
);

lemlib::OdomSensors sensors(&vertTrackingWheel, // vertical tracking wheel 1,
                            nullptr, // vertical tracking wheel 2, set to
nullptr as we are using IMEs nullptr, // horizontal tracking wheel 1 nullptr, //
horizontal tracking wheel 2, &inertial // inertial sensor
);
*/

lemlib::Drivetrain_t drivetrain = {
    &left_side_motors, &right_side_motors, 10, 3.25, 450, 8};
